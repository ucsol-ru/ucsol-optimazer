...
TINY.table=function(){
	...
	sorter.prototype.init=function(){
		...
		if(this.p.colddid){
			d=T$(this.p.colddid);
			var o=document.createElement('option'); o.value=-1; o.innerHTML='Общий поиск'; d.appendChild(o)
		}
		for(i;i<t.w;i++){
			...
			if(d){
				var o=document.createElement('option'); o.value=i; o.innerHTML=T$$('p',c)[0].innerHTML; d.appendChild(o)
			}
		}
		this.reset()
	};
