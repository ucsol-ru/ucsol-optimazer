...
<form class="box style" id="searchForm" action="<?php echo JRoute::_('index.php?option=com_search');?>" method="post" name="searchForm">
	...
	<fieldset>
		...
		<div>
			...
			<button name="Search" onclick="this.form.submit()" style="background-color: rgb(0, 128, 128); color: rgb(255, 255, 255);" class="button"><?php echo JText::_('COM_SEARCH_SEARCH'); ?></button>
		</div>
